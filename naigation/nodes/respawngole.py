...
class Respawn():
    def __init__(self):
        self.modelPath = os.path.dirname(os.path.realpath('.'))
        
        self.modelPath  = '/home/upm/RL_ws/src/naigation/model/goal_box/model.sdf'
        self.humanmodelPath  = '/home/upm/RL_ws/src/hsr_simulation/models/citizen_extras_female_04/model.sdf'
        ...
        self.human_goal_position.position.x = self.goal_position.position.x + 0.4
        self.human_goal_position.position.y = self.goal_position.position.y - 0.25
        quaternion = tf.quaternion_from_euler(0, 0, -0.7)
    ...
    def respawnModel(self):
        while True:
            if not self.check_model:
                ...
                spawn_model_prox('human_'+self.modelName, self.human_model, 'robotos_name_space', self.human_goal_position, "world")
