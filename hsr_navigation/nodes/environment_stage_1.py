...
class Env():
    def __init__(self, action_size):
        ...
        self.position = Pose()
        self.pub_cmd_vel = rospy.Publisher('/hsrb/command_velocity', Twist, queue_size=5)
        self.sub_odom = rospy.Subscriber('/hsrb/odom_ground_truth', Odometry, self.getOdometry)
    ...
    def step(self, action,human):
        ...
        data = None
        data_camera = None
        while data is None and  data_camera is None:
            try:
    ...
    def reset(self,):
        ...
        return np.asarray(state),data_camera